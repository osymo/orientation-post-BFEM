...
public class FormulaireEleve extends JFrame implements ActionListener{
...
private JLabel prenomLabel,nomLabel,dnaissanceLabel,lnaissanceLabel,ecoleLabel,numTableLabel,
moyenneClasse, dominante1, dominante2, dominante3, dominante4, dominante5, dominante6,consigneChoixLabel;
...
public FormulaireEleve(String nomEtablissement){
	/*<----------------------@# Omar
					**********SidyMoctarDiop*****************
...
ecoleField.setText(nomEtablissement);
...
/*<-----------------------------------Gestion et Contrôle des saisies des données tay mou nekh--------------------------->*/
...
numTableField.getDocument().addDocumentListener(new DocumentListener() {
	...
	public void removeUpdate(DocumentEvent e){
		...
		if(b==true) numTableField.setForeground(Color.red);
		else numTableField.setForeground(Color.green);
	}
...
moyenneClasseField.getDocument().addDocumentListener(new DocumentListener() {
	...
	public void removeUpdate(DocumentEvent e){
		...
		if(b==true) moyenneClasseField.setForeground(Color.red);
		else moyenneClasseField.setForeground(Color.green);
	}
...
dominanteField1.getDocument().addDocumentListener(new DocumentListener() {
	...
	public void removeUpdate(DocumentEvent e){
		...
		if(b==true) dominanteField1.setForeground(Color.red);
		else dominanteField1.setForeground(Color.green);
	}
...
dominanteField2.getDocument().addDocumentListener(new DocumentListener() {
	...
	public void removeUpdate(DocumentEvent e){
		...
		if(b==true) dominanteField2.setForeground(Color.red);
		else dominanteField2.setForeground(Color.green);
	}
...
dominanteField3.getDocument().addDocumentListener(new DocumentListener() {
	...
	public void removeUpdate(DocumentEvent e){
		...
		if(b==true) dominanteField3.setForeground(Color.red);
		else dominanteField3.setForeground(Color.green);
	}
...
dominanteField4.getDocument().addDocumentListener(new DocumentListener() {
	...
	public void removeUpdate(DocumentEvent e){
		...
		if(b==true) dominanteField4.setForeground(Color.red);
		else dominanteField4.setForeground(Color.green);
	}
...
dominanteField5.getDocument().addDocumentListener(new DocumentListener() {
	...
	public void removeUpdate(DocumentEvent e){
		...
		if(b==true) dominanteField5.setForeground(Color.red);
		else dominanteField5.setForeground(Color.green);
	}
...
dominanteField6.getDocument().addDocumentListener(new DocumentListener() {
	...
	public void removeUpdate(DocumentEvent e){
		...
		if(b==true) dominanteField6.setForeground(Color.red);
		else dominanteField6.setForeground(Color.green);
	}
...
/*<------------------------------------------Gestion du click sur le boutton envoie----------------------------------->*/
@Override
public void actionPerformed(ActionEvent bouton) {
	...
	if(bouton.getSource()==envoyer){
		...
		if( prenomField.getText().length()>0 && nomField.getText().length()>0 && dateChooser.getDate()!=null && lnaissanceField.getText().length()>0 &&
				ecoleField.getText().length()>0 && numTableField.getText().length()>0 && moyenneClasseField.getText().length()>0 &&
dominanteField1.getText().length()>0 && dominanteField2.getText().length()>0 && dominanteField3.getText().length()>0 &&
dominanteField4.getText().length()>0 && dominanteField5.getText().length()>0 && dominanteField6.getText().length()>0
&& (pTour.isSelected() || sTour.isSelected() || moyenne.isSelected()) )
		{
			
				if(testeurAlaphabétique(prenomField.getText()) && testeurAlaphabétique(nomField.getText()) && testeurNumerique(moyenneClasseField.getText())
						&& testeurNumerique(dominanteField1.getText()) && testeurNumerique(dominanteField2.getText()) && testeurNumerique(dominanteField3.getText())
						&& testeurNumerique(dominanteField4.getText()) && testeurNumerique(dominanteField5.getText()) && testeurNumerique(dominanteField6.getText())
						&& testeurNumerique(numTableField.getText()) && (choix1.getSelectedItem()!=choix2.getSelectedItem() && choix1.getSelectedItem()!=choix3.getSelectedItem()
					...
					if(rangeChecker(note1) && rangeChecker(note2) && rangeChecker(note3)&& rangeChecker(note4) && rangeChecker(note5) && rangeChecker(note6)){
						...
						if(pTour.isSelected()) profil='A';
						else if(sTour.isSelected()) profil='B';
						else profil='C';
						...
						if(unEleve.orienter().equals("plein")==false){
							
							if(SurveillantStatement.insertStudent(unEleve, unEleve.orienter())==true){
								 JOptionPane.showMessageDialog(FormulaireEleve.this, "Enregistrement réussi ", "Succès !", JOptionPane.INFORMATION_MESSAGE);
							}
							else{
								 JOptionPane.showMessageDialog(FormulaireEleve.this, "Le numero de table existe déja", "Erreur !", JOptionPane.ERROR_MESSAGE);
							}
						}
						else{
							JOptionPane.showMessageDialog(FormulaireEleve.this, "Le nombre de places pour la série"+unEleve.orienter()+" est épuisé", "Erreur !", JOptionPane.ERROR_MESSAGE);
						}
					}
					else{
						 JOptionPane.showMessageDialog(FormulaireEleve.this, "Une note doit être entre 0 et 20", "Attention !", JOptionPane.ERROR_MESSAGE);
					}
				}
				else{
					 JOptionPane.showMessageDialog(FormulaireEleve.this, "Veuillez vérifier votre saisie", "Attention !", JOptionPane.ERROR_MESSAGE);
				}
		}
		else{
			JDialog.setDefaultLookAndFeelDecorated( true );
			 JOptionPane.showMessageDialog(FormulaireEleve.this, "Veuillez remplir tous champs svp", "Information !", JOptionPane.WARNING_MESSAGE);
		}
	}
